...
extension GameScene {
    ...
    func addTimer() {
        ...
        timerAddBlock = Timer.scheduledTimer(timeInterval: 4.45, target: self, selector: #selector(GameScene.addBlock), userInfo: nil, repeats: true)
        ...
        case 0: // easy
            ...
            timerAddShieldBottle = Timer.scheduledTimer(timeInterval: 8.45, target: self, selector: #selector(GameScene.addShieldBottle), userInfo: nil, repeats: true)
            ...
            timerAddUfo = Timer.scheduledTimer(timeInterval: 14.363, target: self, selector: #selector(GameScene.addUfo), userInfo: nil, repeats: true)
        ...
        case 1: // medium
            ...
            timerAddShieldBottle = Timer.scheduledTimer(timeInterval: 15.45, target: self, selector: #selector(GameScene.addShieldBottle), userInfo: nil, repeats: true)
            ...
            timerAddUfo = Timer.scheduledTimer(timeInterval: 7.363, target: self, selector: #selector(GameScene.addUfo), userInfo: nil, repeats: true)
        ...
        case 2: // hard
            ...
            timerAddShieldBottle = Timer.scheduledTimer(timeInterval: 30.45, target: self, selector: #selector(GameScene.addShieldBottle), userInfo: nil, repeats: true)
    ...
    func timerInvalidate() {
        ...
        timerAddShieldBottle.invalidate()
        timerAddUfo.invalidate()
        timerAddBlock.invalidate()
    }
}
